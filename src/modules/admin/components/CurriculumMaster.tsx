  ...
  return <div className="space-y-5">
    <div className="bg-white rounded-3xl border border-stone-200 shadow-xs p-5">
      <div className="flex flex-col lg:flex-row lg:items-center justify-between gap-4">
        <div><div className="flex items-center gap-2 text-xs font-bold text-[#10246f] uppercase tracking-wider"><Globe2 className="w-4 h-4 text-[#f20b86]" /> Curriculum Master</div><h2 className="text-2xl font-black text-stone-900 mt-1">Country → Region → Curriculum</h2><p className="text-xs text-stone-500 mt-1">Manage the global curriculum hierarchy used by Question Bank, Question Creator and bulk imports.</p></div>
